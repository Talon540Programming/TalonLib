...
/**
 * Create a type of {@link UnboundRobotPositionMap} which has a specific limit on the number of
 * entries that can be made into the map. This is usually for memory and speed purposes
 */
