...
// THIS IS WPILIB'S CODE, I JUST NEED TO  CHANGE ONE SMALL LITTLE THING THEY MADE FINAL
...
public class SwervePIDController implements Sendable, AutoCloseable {
     ...
     */
    public SwervePIDController(double kp, double ki, double kd, double period) {
        m_kp = kp;
        m_ki = ki;
        m_kd = kd;
    ...
    public double calculateWithCustomPeriod(double measurement, double setPoint, double period) {
        setSetpoint(setPoint);
