...
public class TalonXboxController extends CommandXboxController {
  ...
  public void startRumble(double percent) {
    this.getHID().setRumble(GenericHID.RumbleType.kLeftRumble, percent);
    this.getHID().setRumble(GenericHID.RumbleType.kRightRumble, percent);
  }
  ...
  public void stopRumble() {
    this.getHID().setRumble(GenericHID.RumbleType.kLeftRumble, 0);
    this.getHID().setRumble(GenericHID.RumbleType.kRightRumble, 0);
  }
