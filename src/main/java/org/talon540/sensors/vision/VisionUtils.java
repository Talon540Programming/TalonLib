...
public final class VisionUtils {
    ...
    /**
     * Algorithm from <a href="https://docs.limelightvision.io/en/latest/cs_estimating_distance.html">...</a> Estimates
    ...
    /**
     * Algorithm from <a href="https://docs.limelightvision.io/en/latest/cs_estimating_distance.html">...</a> Estimates
     * range to a target (hypotenuse formed between the camera, base, and the target) using the target's elevation.
     *
     * @param cameraHeightMeters The physical height of the camera off the floor in meters.
     * @param targetHeightMeters The physical height of the target off the floor in meters. This
     *     should be the height of whatever is being targeted (i.e. if the targeting region is set to
    ...
    public static double calculateDistanceToTargetHypotenuseMeters(
        ...
        return (targetHeightMeters - cameraHeightMeters)/ Math.sin(cameraPitchRadians + targetPitchRadians);
    }
     ...
     * @param targetPitchRadians The pitch of the target in the camera's lens in radians. Positive
     *     values up.
     * @param targetYawRadians The yaw of the target in the camera's lens in radians. Positive
     *     values right.
     * @param robotToCamera {@link Vector2d } position of the camera relative to the center (0, 0) of the robot
    ...
    public static double calculateDistanceToTargetBaseFromRobotCenterMeters(
        ...
        double distanceFromTargetMeters = calculateDistanceToTargetBaseMeters(
                cameraHeightMeters,
                targetHeightMeters,
                cameraPitchRadians,
                targetPitchRadians
